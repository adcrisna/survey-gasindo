  ...
  <aside class="main-sidebar control-sidebar-red">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="{{ route('survey_gas') }}">
            <i class="fa fa-envelope"></i> <span>Data Survey Tabung</span>
          </a>
        </li>
        <li>
          <a href="{{ route('survey_layanan') }}">
            <i class="fa fa-envelope"></i> <span>Data Survey Layanan</span>
          </a>
        </li>
        <li>
          <a href="{{ route('csi_gas') }}">
            <i class="fa fa-list-alt"></i> <span>Data CSI Tabung</span>
          </a>
        </li>
        <li>
          <a href="{{ route('csi_layanan') }}">
            <i class="fa fa-list-alt"></i> <span>Data CSI Layanan</span>
          </a>
        </li>
        <li>
          <a href="{{ route('hasil_csi') }}">
            <i class="fa fa-list-alt"></i> <span>Hasil CSI</span>
          </a>
        </li>
        <li>
          <a href="{{ route('data_perusahaan') }}">
            <i class="fa fa-building"></i> <span>Profile Perusahaan</span>
          </a>
        </li>
        <li>
          <a href="{{ route('pertanyaan_produk') }}">
            <i class="fa fa-edit"></i> <span>Pertanyaan Tabung</span>
          </a>
        </li>
        <li>
          <a href="{{ route('pertanyaan_layanan') }}">
            <i class="fa fa-edit"></i> <span>Pertanyaan Layanan</span>
          </a>
        </li>
        <li>
          <a href="{{ route('profile_admin') }}">
            <i class="fa fa-gear"></i> <span>Profile Admin</span>
          </a>
        </li>
        <li>
